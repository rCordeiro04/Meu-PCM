...
st.markdown(
    ...
    <style>
        ...
        /* DESIGN EXECUTIVO PREMIUM DOS CARDS KPI SUPERIORES */
        .card-kpi-bonito {{
            background: #ffffff;
            border: 1px solid #e2e8f0;
            border-radius: 10px;
        ...
        /* Botão invisível sobreposto para interatividade */
        .col-kpi-wrapper {{
            position: relative;
            height: 64px;
        }}
...
if tela == "Painel Correias":
    ...
    # 4 Cartões KPI com os novos rótulos padronizados e design executivo
        ...
        st.markdown(
            ...
            <div class="col-kpi-wrapper">
                <div class="card-kpi-bonito c-total">
                    <div>
                        <div class="kpi-lbl">Tipos Totais</div>
        ...
        st.markdown(
            ...
            <div class="col-kpi-wrapper">
                <div class="card-kpi-bonito c-ok">
                    <div>
                        <div class="kpi-lbl">Tipos Nova</div>
        ...
        st.markdown(
            ...
            <div class="col-kpi-wrapper">
                <div class="card-kpi-bonito c-warn">
                    <div>
                        <div class="kpi-lbl">Tipos Meia Vida</div>
        ...
        st.markdown(
            ...
            <div class="col-kpi-wrapper">
                <div class="card-kpi-bonito c-crit">
                    <div>
                        <div class="kpi-lbl">Tipos para Troca</div>
